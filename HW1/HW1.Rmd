...
#Match pname
pnameRead = str_match_all(d, " pname=\"([a-zA-Z ]*)\"")
...
#Match pteam
pteamRead = str_match_all(d, " pteam=\"([a-zA-Z ]*)\"")
...
for (i in 1:193) {
  paddtime[i,] = ptype[[i]][,2] 
}

#Match ptype
ptypeRead = str_match_all(d, " ptype=\"([a-z ]*)\"")
...
#Match pmatch
pmatchRead = str_match_all(d, " pmatch=\"([a-z/a-z.a-z ]*)\"")
