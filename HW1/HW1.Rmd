...
```{r}
library(ggplot2)
#plot1: When goals of each team happen? It shows that each team tends to be more defensive or offensive in this World Cup 
...
#select useful information and rename them
...
#we build 3-layers struture. The first layer is match, the second one is team and the third one is goal. 
