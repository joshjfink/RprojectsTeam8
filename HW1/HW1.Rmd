...
<<<<<<< HEAD
#Match top
topRead = str_match_all(d, "top: ([0-9]*)px.")
top = matrix(NA, 193, 1, byrow = T)
for (i in 2:193) {
  top[i,] = topRead[[i]][,2] 
}

Data = data.frame(ID = id, pig = pig, class = class, pid = pid, mid = mid, pname = pname, pteam = pteam, ptime = ptime, paddtime = paddtime, ptype = ptype, pteamimg = pteamimg, pmatch = pmatch, style.left = style.left, style.right = style.right, top = top)
=======
#Match style.top
...
>>>>>>> da3bd170b0c5e88e2e1f07b678e7d8e2553f1257
Data
```
