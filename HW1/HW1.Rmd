...
#Match style.right
style.rightRead = str_match_all(d, "style=\"right. ([0-9]*)px.")
...
for (i in 1:193) {
  style.left[i,] = style.leftRead[[i]][,2] 
}

cbind(id, pig, class, pid, mid, pname, pteam, ptime, paddtime, ptype, pteamimg, pmatch, style.right, style.left)
```
